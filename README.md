...
> 个人精选工具导航站 · 39+ 亲测可用资源 · 不机器采集 · 每季度复核
...
`astras.cc` 是由 [@ningqi24](https://github.com/ningqi24) 个人维护的聚合导航站。收录 AstraEditor、Scratch 衍生项目（OS / UI）、前端工具、聊天服务、字体 CDN、小游戏与个人作品等 39+ 条资源。每条均附"亲测时间徽章 + 主观点评"，每季度复核，不靠机器采集。
...
├── site.json               # 资源数据（39+ 条，含 verified_date / note / note_en）
├── sitemap.xml             # 站点地图
